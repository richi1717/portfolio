    ...
    return (
      <div className="about-me">
        ...
        <p>
          ...
          games, I'm usually playing board games, the guitar,
          piano, or bass, or trying to learn a new instrument.
          My collection of video games, posters, books, and figures rivals
          that of GameStop and Best Buy.  I have a sense of humor which
          most people enjoy and I get along with everyone.  I don't like
          to watch sports but I do enjoy playing basketball, soccer, 
          and throwing footballs or baseballs around.
        </p>
      </div>
    );
  }
